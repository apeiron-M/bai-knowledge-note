          ...
          operations: [
            ...
            },
            {
              ...
              errors: [
                ...
                {
                  id: "err-invalid-metadata-value",
                  name: "InvalidMetadataValueError",
                  code: "INVALID_METADATA_VALUE",
                  description:
                    "confidence, severity and decisionStatus take a closed vocabulary",
                  template: "",
                },
              ],
              examples: [],
          ...
          operations: [
            {
              ...
              template:
                "Record author, source origin, session ID, and creation timestamp",
              reducer:
                "// createdAt is written once. Author and origin may be corrected later (the\n// editor offers that), but the creation time is not negotiable \u2014 pass the\n// existing value back unchanged.\nif (state.provenance && action.input.createdAt !== state.provenance.createdAt) {\n  throw new ProvenanceCreatedAtImmutableError(\n    `provenance.createdAt is ${state.provenance.createdAt} and cannot be changed`,\n  );\n}\nconst lastTouched = state.updatedAt || action.input.createdAt;\nstate.provenance = {\n  author: action.input.author,\n  sourceOrigin: action.input.sourceOrigin,\n  sessionId: action.input.sessionId || null,\n  createdAt: action.input.createdAt,\n  updatedAt: lastTouched,\n};\nif (!state.updatedAt) state.updatedAt = action.input.createdAt;",
              errors: [
                {
                  id: "err-provenance-created-at-immutable",
                  name: "ProvenanceCreatedAtImmutableError",
                  code: "PROVENANCE_CREATED_AT_IMMUTABLE",
                  description:
                    "provenance.createdAt cannot change once set; author and sourceOrigin can",
                  template: "",
                },
              ],
              examples: [],
