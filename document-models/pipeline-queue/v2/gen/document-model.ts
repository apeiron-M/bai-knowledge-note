          ...
          operations: [
            {
              ...
              errors: [
                {
                  id: "7cc6ce62-653f-4611-923d-caf2ed27a513",
            ...
            },
            {
              ...
              errors: [
                ...
                {
                  id: "42c6538a-e73d-4bae-94cf-932171ae25e0",
                  name: "TaskAlreadyAssignedError",
                  code: "TASK_ALREADY_ASSIGNED",
                  description: "The task is already assigned to another actor",
                  template: "",
                },
              ],
              schema:
          ...
          operations: [
            {
              ...
              errors: [
                ...
                {
                  id: "err-unknown-task-type",
                  name: "UnknownTaskTypeError",
                  code: "UNKNOWN_TASK_TYPE",
                  description:
                    "taskType has no entry in phaseOrder; such a task could never advance or complete",
                  template: "",
                },
                {
                  id: "err-invalid-phase-add",
                  name: "InvalidPhaseError",
                  code: "INVALID_PHASE",
                  description: "currentPhase is not a phase of the task type",
                  template: "",
                },
              ],
              schema:
            ...
            },
            {
              ...
              errors: [
                ...
                {
                  id: "err-invalid-task-status-advance",
                  name: "InvalidTaskStatusError",
                  code: "INVALID_TASK_STATUS",
                  description:
                    "Only PENDING or IN_PROGRESS tasks advance; a DONE task must not be resurrected",
                  template: "",
                },
                {
                  id: "err-phase-mismatch",
                  name: "PhaseMismatchError",
                  code: "PHASE_MISMATCH",
                  description:
                    "The handoff names a phase other than the task's current phase",
                  template: "",
                },
              ],
              schema:
            ...
            },
            {
              ...
              errors: [
                ...
                {
                  id: "err-invalid-task-status-complete",
                  name: "InvalidTaskStatusError",
                  code: "INVALID_TASK_STATUS",
                  description:
                    "Task is already DONE or FAILED; completing again double-counts completedCount",
                  template: "",
                },
              ],
              schema:
            ...
            },
            {
              ...
              errors: [
                ...
                {
                  id: "err-invalid-task-status-fail",
                  name: "InvalidTaskStatusError",
                  code: "INVALID_TASK_STATUS",
                  description:
                    "Task is already DONE or FAILED; failing again decrements activeCount twice",
                  template: "",
                },
              ],
              schema:
            ...
            },
            {
              ...
              errors: [
                ...
                {
                  id: "err-invalid-task-status-block",
                  name: "InvalidTaskStatusError",
                  code: "INVALID_TASK_STATUS",
                  description:
            ...
            {
              id: "reconcile-counters",
              name: "RECONCILE_COUNTERS",
              description:
                "Recompute completedCount and activeCount from the tasks",
              schema:
