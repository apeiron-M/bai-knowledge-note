...
export function AddProjectKnowledgeRefInputSchema(): z.ZodObject<
  Properties<AddProjectKnowledgeRefInput>
> {
  return z.object({
    projectId: z.string(),
    ref: z.string(),
...
export function LinkDeliverableGoalInputSchema(): z.ZodObject<
  Properties<LinkDeliverableGoalInput>
> {
  return z.object({
    deliverableId: z.string(),
    goalRef: z.string().nullish(),
...
export function LinkProjectWbsInputSchema(): z.ZodObject<
  Properties<LinkProjectWbsInput>
> {
  return z.object({
    projectId: z.string(),
...
export function RemoveProjectKnowledgeRefInputSchema(): z.ZodObject<
  Properties<RemoveProjectKnowledgeRefInput>
> {
  return z.object({
    projectId: z.string(),
    ref: z.string(),
...
export function SetProjectReferencesInputSchema(): z.ZodObject<
  Properties<SetProjectReferencesInput>
> {
  return z.object({
    projectId: z.string(),
    references: z.array(z.url()),
