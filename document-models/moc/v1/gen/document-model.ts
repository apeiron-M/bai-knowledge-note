      ...
      modules: [
        {
          ...
          operations: [
            ...
            },
            {
              ...
              description:
                "Set a whitelisted string metadata field on the MoC. Currently only `version`, which records the Powerhouse stack release the MoC's knowledge is registered against.",
              schema:
              ...
              errors: [
                {
                  ...
                  description:
                    "The supplied field name is not a recognized string metadata field.",
                  template: "",
                },
              ],
              examples: [],
