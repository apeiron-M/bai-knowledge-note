---
description: AI agent for managing a Powerhouse Knowledge Vault — seeding sources, extracting atomic notes, connecting and verifying them via the Switchboard CLI and the graph index.
mode: primary
---
...
> `agents/knowledge-agent.md`). Regenerate from the plugin; do not hand-edit the body.
>
...
> `switchboard docs apply`, and read state back manually after every write.
