    ...
    >
      ...
      {quote ? (
        ...
        <p className="mt-1.5" style={{ color: "var(--bai-text-faint)" }}>
          {anchor
            ? "Cites one item of this document."
            : "No passage identified — open to read."}
        </p>
      )}
      {stale && (
 ...
 * click. No hover card here: the passage lives on the inline chip, and a row
 * of chips that each pop a card on the way to the one you want is noise.
 */
